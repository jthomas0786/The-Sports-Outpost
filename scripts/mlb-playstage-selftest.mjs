...
const leftFly=t.hitTarget({result:{description:'Fly ball to left field'}},'fly_out'); assert.ok(leftFly[0]<50&&leftFly[1]<60,'left-field fallback must stay left and in the outfield');
...
assert.ok(router.includes("./mlb/playstage-v901.js?v=90.44"),'Router must cache-bust MLB PlayStage');
