...
assert.ok(router.includes("./mlb/playstage-v901.js?v=90.45")||router.includes("./mlb/playstage-v901.js?v=90.45"),'router must cache-bust isolated MLB PlayStage');
assert.ok(index.includes('./sports/router.js?v=90.47')||index.includes('./sports/router.js?v=90.47'),'index must cache-bust the updated router');
