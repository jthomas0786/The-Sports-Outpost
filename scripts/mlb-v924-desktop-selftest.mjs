...
assert.ok(fit.includes("footer.style.setProperty('margin-top'"),'desktop footer gap correction must override important margin rules');
assert.ok(fit.includes("'important'"),'desktop footer gap correction must be applied with important priority');
...
console.log('MLB v924 regression passed: full-width desktop fit, border containment, enforced tight footer, stable 5s polling');
