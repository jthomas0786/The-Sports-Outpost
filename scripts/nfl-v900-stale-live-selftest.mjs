...
assert.ok(v890.includes("import('./nfl-preview.js?v=89.38')")||v890.includes("import('./nfl-preview.js?v=89.38')"),'fresh base preview must remain cache-busted');
assert.ok(wrapper.includes("./nfl-preview-v890.js?v=89.38")||wrapper.includes("./nfl-preview-v890.js?v=89.38"),'NFL wrapper base import must remain cache-busted');
...
assert.ok(router.includes("./nfl-preview-v893.js?v=89.38")||router.includes("./nfl-preview-v893.js?v=89.38"),'router must retain stale-live fix or newer NFL build');
