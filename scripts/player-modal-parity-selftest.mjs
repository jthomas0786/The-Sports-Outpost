...
console.log('Player modal parity: actual MLB .modal shell, NFL .ms-modal shell, and NHL shell all keep the header outside the scroll body; Watch List + Close use a dedicated action column.');