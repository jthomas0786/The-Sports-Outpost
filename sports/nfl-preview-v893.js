...
import { installNflPlayerPropToolSnapshotV928 } from './nfl/player-prop-tool-snapshot-v928.js?v=92.8';
...
function arm(){
  ...
  }catch(e){console.warn('[NFL Player Prop Tool v92.8] unavailable:',e);}
