...
import { installNflLiveGameSwitcherV894 } from './nfl/live-game-switcher-v894.js?v=89.5';
...
function arm(){
  ...
  try{installNflLiveGameSwitcherV894();}catch(e){console.warn('[NFL Live v89.5] game switcher unavailable:',e);}
