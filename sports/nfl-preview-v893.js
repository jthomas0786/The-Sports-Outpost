...
import { installNflGamecastPossessionBallV8922 } from './nfl/gamecast-possession-ball-v8922.js?v=89.22';
...
function arm(){
  ...
  try{installNflGamecastPossessionBallV8922();}catch(e){console.warn('[NFL Gamecast v89.22] possession football unavailable:',e);}
