...
function arm(){
  ...
  try{ensurePlayerPropVisibilityV927();installNflPlayerPropToolV926({selectBaseTab:tab=>basePreview.selectTab?.(tab)});}catch(e){console.warn('[NFL Player Prop Tool v92.7] unavailable:',e);}
