...
import { installNflPlayerPropToolStaticGuardV929 } from './nfl/player-prop-tool-static-guard-v929.js?v=92.9';
...
function arm(){
  ...
  }catch(e){console.warn('[NFL Player Prop Tool v92.9] unavailable:',e);}
