...
import { installNflPlayerPropToolSnapshotV928 } from './nfl/player-prop-tool-snapshot-v928.js?v=92.8.1';
import { installNflPlayerPropToolStaticGuardV929 } from './nfl/player-prop-tool-static-guard-v929.js?v=92.9.2';
...
function arm(){
  ...
  }catch(e){console.warn('[NFL Player Prop Tool v92.9.2] unavailable:',e);}
