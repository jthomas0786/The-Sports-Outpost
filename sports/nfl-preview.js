...
// v73 — exact NFL Gamecast concept canvas.  The Game View is authored once at
...
function ensureNflGamecastConceptStyles(){
  if(document.getElementById('nfl-gamecast-concept-v73')) return;
  const style=document.createElement('style');
  style.id='nfl-gamecast-concept-v73';
  style.textContent=`
  ...
  #nflView .nxg-concept .nxg-topbar{height:62px;margin:0!important;padding:10px 16px 8px;display:grid!important;grid-template-columns:292px 448px minmax(0,1fr);align-items:center;gap:12px;background:#020a18;border:0!important;box-sizing:border-box}
  #nflView .nxg-concept-brand{height:44px;display:flex;align-items:center;gap:14px;white-space:nowrap}
  #nflView .nxg-concept-brand .mark{font:900 italic 43px/1 'Oswald',sans-serif;letter-spacing:-.08em;color:#319cff;text-shadow:0 2px 0 #08478f,0 0 18px rgba(49,156,255,.25)}
  #nflView .nxg-concept-brand .word{font:800 italic 17px/1 'Oswald',sans-serif;letter-spacing:.055em;color:#45a5ff;text-transform:uppercase}
  ...
  #nflView .nxg-concept .nxg-scorebar{height:154px!important;min-height:154px!important;margin:0 16px!important;width:1416px!important;display:grid!important;grid-template-columns:520px 300px 428px 168px!important;overflow:hidden!important;border:1px solid rgba(45,127,255,.52)!important;border-radius:14px!important;background:linear-gradient(180deg,rgba(9,31,63,.98),rgba(5,20,43,.98))!important;box-shadow:0 10px 32px rgba(0,0,0,.22)!important}
  #nflView .nxg-concept .nxg-teamblock{height:152px!important;box-sizing:border-box!important;padding:18px 28px!important;display:grid!important;grid-template-columns:132px minmax(0,1fr) 112px!important;align-items:center!important;gap:18px!important;background:linear-gradient(90deg,rgba(11,38,74,.32),rgba(4,16,35,.08))!important}
  #nflView .nxg-concept .nxg-teamblock.home{grid-template-columns:112px minmax(0,1fr) 132px!important;text-align:right!important;background:linear-gradient(270deg,rgba(11,38,74,.32),rgba(4,16,35,.08))!important}
  #nflView .nxg-concept .nxg-teamlogo{width:126px!important;height:76px!important;object-fit:contain!important;filter:drop-shadow(0 5px 7px rgba(0,0,0,.28))}
  #nflView .nxg-concept .nxg-teamcopy small{display:block!important;margin-bottom:4px!important;color:#9bc5fb!important;font:700 13px/1.05 'JetBrains Mono',monospace!important;letter-spacing:.03em!important}
  #nflView .nxg-concept .nxg-teamcopy b{display:block!important;color:white!important;font:900 31px/.98 'Oswald',sans-serif!important;letter-spacing:.015em!important;text-transform:uppercase!important;white-space:nowrap!important}
  ...
  #nflView .nxg-concept .nxg-score{font:900 74px/.82 'Oswald',sans-serif!important;letter-spacing:-.04em!important;color:#f9fbff!important;text-shadow:0 3px 0 rgba(0,0,0,.25)!important}
  ...
  #nflView .nxg-concept .nxg-period{font:900 21px/1 'Oswald',sans-serif!important;color:#2f9cff!important;letter-spacing:.015em!important}
  #nflView .nxg-concept .nxg-clock{font:900 42px/.96 'Oswald',sans-serif!important;color:#fff!important;letter-spacing:.015em!important}
  ...
  #nflView .nxg-concept .nxg-weather{height:152px!important;box-sizing:border-box!important;padding:19px 15px!important;border-left:1px solid rgba(45,127,255,.2)!important;display:flex!important;flex-direction:column!important;align-items:flex-start!important;justify-content:center!important;gap:6px!important;text-align:left!important;background:rgba(4,16,35,.25)!important}
  #nflView .nxg-concept .nxg-weather-top{display:flex!important;align-items:center!important;gap:8px!important}.nxg-concept .nxg-weather-ico{font-size:20px!important}.nxg-concept .nxg-weather strong{font:900 34px/1 'Oswald',sans-serif!important;color:#fff!important}.nxg-concept .nxg-weather small{font:700 13px/1.2 'Oswald',sans-serif!important;color:#fff!important}.nxg-concept .nxg-weather>span{font:500 11px/1.2 'JetBrains Mono',monospace!important;color:#9eb9dc!important}
  ...
  #nflView .nxg-concept .nxg-brandmark-exact{left:50%!important;top:147px!important;transform:translateX(-50%)!important;z-index:5!important;display:flex!important;align-items:center!important;gap:10px!important;color:#168cff!important;text-shadow:0 0 16px rgba(22,140,255,.65)!important;font:900 italic 34px/1 'Oswald',sans-serif!important;letter-spacing:-.05em!important}
  #nflView .nxg-concept .nxg-brandmark-exact span{font:800 13px/1.05 'Oswald',sans-serif!important;letter-spacing:.08em!important;color:#1886e9!important;text-transform:uppercase!important;max-width:110px!important}
  #nflView .nxg-concept .nxg-nfllive,#nflView .nxg-concept .nxg-fieldtag{display:none!important}

  #nflView .nxg-concept .nxg-overlay-stack{position:absolute!important;top:36px!important;z-index:8!important;display:flex!important;flex-direction:column!important;gap:12px!important;width:410px!important}
  #nflView .nxg-concept .nxg-overlay-stack.left{left:18px!important}.nxg-concept .nxg-overlay-stack.right{right:18px!important}
  #nflView .nxg-concept .nxg-overlay-panel{width:410px!important;box-sizing:border-box!important;padding:13px 16px!important;border:1px solid rgba(55,151,255,.55)!important;border-radius:10px!important;background:linear-gradient(180deg,rgba(3,17,39,.60),rgba(3,15,34,.39))!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important;box-shadow:0 10px 24px rgba(0,0,0,.10)!important;color:#fff!important}
  #nflView .nxg-concept .nxg-overlay-scoring{height:144px!important}.nxg-concept .nxg-overlay-drive{height:288px!important}.nxg-concept .nxg-overlay-metrics{height:144px!important}.nxg-concept .nxg-overlay-watch{height:244px!important}
  #nflView .nxg-concept .nxg-overlay-title{height:24px!important;box-sizing:border-box!important;margin:0 0 9px!important;padding:0 0 8px!important;border-bottom:1px solid rgba(70,155,255,.36)!important;color:#2d9fff!important;font:900 12px/1 'JetBrains Mono',monospace!important;letter-spacing:.055em!important;text-transform:uppercase!important;display:flex!important;align-items:center!important}
  #nflView .nxg-concept .nxg-overlay-scoring-row{display:flex!important;align-items:center!important;gap:14px!important}.nxg-concept .nxg-gauge-sm{width:76px!important;height:76px!important;flex:0 0 76px!important}.nxg-concept .nxg-gauge-sm::after{inset:9px!important}.nxg-concept .nxg-gauge-sm b{font:900 19px/1 'Oswald',sans-serif!important}.nxg-concept .nxg-overlay-copy strong{font:900 18px/1 'Oswald',sans-serif!important;color:#63e777!important}.nxg-concept .nxg-overlay-copy span{display:block!important;margin-top:6px!important;color:#d8e7fb!important;font:500 10px/1.45 'JetBrains Mono',monospace!important}
  #nflView .nxg-concept .nxg-overlay-meta{display:flex!important;align-items:center!important;gap:8px!important;flex-wrap:nowrap!important;color:#fff!important;font:800 10px/1 'JetBrains Mono',monospace!important;text-transform:uppercase!important}.nxg-concept .nxg-overlay-meta img,.nxg-concept .nxg-overlay-meta .ms-nfl-team-logo{width:22px!important;height:18px!important;object-fit:contain!important}
  #nflView .nxg-concept .nxg-overlay-plays{display:flex!important;flex-direction:column!important;gap:9px!important;margin-top:12px!important}.nxg-concept .nxg-overlay-play{display:grid!important;grid-template-columns:12px minmax(0,1fr)!important;gap:9px!important;align-items:start!important}.nxg-concept .nxg-overlay-play i{width:10px!important;height:10px!important;border-radius:50%!important;background:#44e493!important;box-shadow:0 0 0 2px rgba(68,228,147,.14)!important;margin-top:2px!important}.nxg-concept .nxg-overlay-play.current i{background:#dceaff!important}.nxg-concept .nxg-overlay-play small{display:block!important;color:#9ab6dc!important;font:500 9px/1.15 'JetBrains Mono',monospace!important;margin:0 0 2px!important}.nxg-concept .nxg-overlay-play span{display:block!important;color:white!important;font:500 10px/1.25 'JetBrains Mono',monospace!important;white-space:normal!important}
  #nflView .nxg-concept .nxg-overlay-metric-grid{display:grid!important;grid-template-columns:repeat(4,1fr)!important;gap:0!important;height:87px!important}.nxg-concept .nxg-overlay-metric-grid>div{position:relative!important;text-align:center!important;padding:7px 6px!important;border-right:1px solid rgba(89,154,230,.25)!important}.nxg-concept .nxg-overlay-metric-grid>div:last-child{border-right:0!important}.nxg-concept .nxg-overlay-metric-grid b{display:block!important;color:#fff!important;font:900 25px/1 'Oswald',sans-serif!important}.nxg-concept .nxg-overlay-metric-grid span{display:block!important;margin-top:7px!important;color:#d7e5f7!important;font:700 8px/1.1 'JetBrains Mono',monospace!important;text-transform:uppercase!important}.nxg-concept .nxg-overlay-metric-grid small{display:block!important;margin-top:5px!important;color:#9dc4f4!important;font:700 8px/1 'JetBrains Mono',monospace!important}
  #nflView .nxg-concept .nxg-overlay-watch-list{display:flex!important;flex-direction:column!important;gap:0!important}.nxg-concept .nxg-overlay-watch-row{height:63px!important;box-sizing:border-box!important;display:grid!important;grid-template-columns:48px minmax(0,1fr) 146px!important;gap:10px!important;align-items:center!important;padding:7px 0!important;border-bottom:1px solid rgba(85,154,230,.20)!important}.nxg-concept .nxg-overlay-watch-row:last-child{border-bottom:0!important}.nxg-concept .nxg-overlay-watch-avatar{width:45px!important;height:45px!important;border-radius:8px!important;border:1px solid rgba(63,150,255,.45)!important;background:#09234b!important;overflow:hidden!important}.nxg-concept .nxg-overlay-watch-avatar img{width:100%!important;height:100%!important;object-fit:cover!important}.nxg-concept .nxg-overlay-watch-copy{min-width:0!important}.nxg-concept .nxg-overlay-watch-copy b{display:block!important;color:#fff!important;font:800 14px/1 'Oswald',sans-serif!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}.nxg-concept .nxg-overlay-watch-copy small{display:block!important;margin-top:4px!important;color:#8caed8!important;font:600 9px/1 'JetBrains Mono',monospace!important}.nxg-concept .nxg-overlay-watch-stats{display:grid!important;grid-template-columns:repeat(3,1fr)!important;gap:4px!important}.nxg-concept .nxg-overlay-watch-stats div{text-align:center!important}.nxg-concept .nxg-overlay-watch-stats b{display:block!important;color:#fff!important;font:900 17px/1 'Oswald',sans-serif!important}.nxg-concept .nxg-overlay-watch-stats span{display:block!important;margin-top:4px!important;color:#d2e0f3!important;font:700 8px/1 'JetBrains Mono',monospace!important;text-transform:uppercase!important}
...
function fitNflGamecastConcept(root=document){
  ...
  const viewport=root.querySelector?.('.nxg-concept-viewport');
  const canvas=viewport?.querySelector?.('.nxg-concept-canvas');
  ...
  const fit=()=>{
    ...
    viewport.style.height=`${NFL_GAMECAST_CANVAS_H*scale}px`;
  };
  fit();
  if('ResizeObserver' in window){
    _nflGamecastResizeObserver=new ResizeObserver(fit);
    _nflGamecastResizeObserver.observe(viewport);
...
function fieldOverlayLiveRedesignHTML(g,p){
  ...
  const targetLabel=point(target,.37);
  const playerNo=String(p?.id||'88').slice(-2);
  return `<section class="nxg-live-stage"><div class="nxg-fieldshell nxg-fieldshell-live nxg-fieldshell-exact"><div class="nxg-stadium-exact"><div class="nxg-stadium-lights"></div><div class="nxg-stadium-crowd"></div></div><div class="nxg-brandmark-exact">TSO <span>THE SPORTS<br>OUTPOST</span></div><div class="nxg-nfllive"><span>🏈</span><b>NFL LIVE</b></div><div class="nxg-fieldtag">${esc(g.status==='in'?downDistanceLabel(g):'Pregame')}</div><div class="nxg-fieldart-frame"><img class="nxg-fieldart-img" src="${NFL_FIELD_ART}" alt="The Sports Outpost football field"><div class="nxg-fieldart-shade"></div><svg class="nxg-fieldsvg" viewBox="0 0 1536 600" preserveAspectRatio="none" aria-label="NFL field visualization"><defs><filter id="nxgShadowExact-${esc(g.id)}"><feDropShadow dx="0" dy="4" stdDeviation="6" flood-opacity=".42"/></filter></defs><line x1="${losA.x}" y1="${losA.y}" x2="${losB.x}" y2="${losB.y}" class="nxg-svg-los"/><line x1="${fdA.x}" y1="${fdA.y}" x2="${fdB.x}" y2="${fdB.y}" class="nxg-svg-first"/>${offDef.join('')}<path d="M ${ballPt.x} ${ballPt.y} Q ${ctrl.x} ${ctrl.y} ${targetPt.x} ${targetPt.y}" class="nxg-svg-route"/><path d="M ${ballPt.x} ${ballPt.y} Q ${point(clamp(ball+dir*.06,.08,.92),.57).x} ${point(clamp(ball+dir*.06,.08,.92),.57).y} ${point(clamp(ball+dir*.14,.08,.92),.45).x} ${point(clamp(ball+dir*.14,.08,.92),.45).y}" class="nxg-svg-route-dash"/><ellipse cx="${ballPt.x}" cy="${ballPt.y}" rx="12" ry="7" transform="rotate(-18 ${ballPt.x} ${ballPt.y})" class="nxg-svg-ball"/><g transform="translate(${targetLabel.x-44},${targetLabel.y-20})" filter="url(#nxgShadowExact-${esc(g.id)})"><rect width="88" height="40" rx="10" fill="#071a3b" stroke="#258cff" stroke-width="1.4"/><circle cx="20" cy="20" r="11" fill="#1688ff"/><text x="20" y="24" text-anchor="middle" fill="#fff" font-size="9" font-weight="800">${esc((p?.team||ctx.offense.abbr).slice(0,3))}</text><text x="38" y="24" fill="#fff" font-size="11" font-weight="800">#${esc(playerNo)}</text></g></svg></div><div class="nxg-overlay-stack left"><div class="nxg-overlay-block">${scoringChanceOverlayHTML(g)}</div><div class="nxg-overlay-block">${currentDriveOverlayHTML(g)}</div></div><div class="nxg-overlay-stack right"><div class="nxg-overlay-block">${driveMetricsOverlayHTML(g)}</div><div class="nxg-overlay-block">${playersWatchOverlayHTML(g)}</div></div><div class="nxg-fieldlegend"><span><i class="off"></i>Offense (${esc(ctx.offense.abbr)})</span><span><i class="def"></i>Defense (${esc(ctx.defense.abbr)})</span><span><i class="los"></i>Line of Scrimmage</span><span><i class="fd"></i>First Down</span><span><i class="path"></i>Play Path</span></div></div></section>`;
}
...
function gamecastDashboardHTML(g,p,{embedded=false,tab=null}={}){
  ...
  const topbar=`<div class="nxg-topbar"><div class="nxg-concept-brand"><span class="mark">TSO</span><span class="word">THE SPORTS OUTPOST</span></div><div class="nxg-tabs">${tabButton('game','Game View')}${tabButton('box','Box Score')}${tabButton('pbp','Play by Play')}</div><div class="nxg-tools">${statusTool}<span class="nxg-feedpill">Gamecast Feed⌄</span><button type="button" class="nxg-dotbtn" title="More">•••</button>${backTool}</div></div>`;
...
export async function mount(){ ensureNflGamecastConceptStyles(); await loadData(); bindLegacyNflNav(); render(); }
