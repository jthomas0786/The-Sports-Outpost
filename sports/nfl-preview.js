...
function gamecastDashboardHTML(g,p,{embedded=false,tab=null}={}){
  ...
  const gameView=`<div class="nxg-gameview-modern">${fieldOverlayLiveRedesignHTML(g,p)}<div class="nxg-footerline"><span>NFL Gamecast</span><span>${live?'Live Data':'Game Preview'}</span><span>The Sports Outpost</span></div></div>`;
