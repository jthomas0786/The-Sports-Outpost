import { mountOrUpdateNflPlaystageV885a as mountOrUpdateNflPlaystageV885, renderNflPlaystageV885aHTML } from './nfl/playstage-v885a.js?v=88.5c';
import { ensureNflPlaystageV885Styles } from './nfl/gamecast-v885-styles.js?v=88.5c';
  ...
  try{
    ...
    if(!NFL_DEMO_MODE) startLivePolling(d,()=>{
      ...
      if(state.game && state.gamecastTab==='game'){
        ...
        if(current && root.querySelector('[data-tso-v885-gamecast]')){ requestAnimationFrame(()=>render()); return; }
