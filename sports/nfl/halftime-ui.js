...
export function ensureHalftimeLabStyles(){
  ...
  const st=document.createElement('style');st.id='tso-nfl-halftime-lab-v88';
  st.textContent=`
  ...
  .tso-ht-scroll{overflow:auto;flex:1;padding:14px 20px 100px}
  .tso-ht-section{margin-bottom:16px}.tso-ht-label{display:block;margin-bottom:7px;font:900 8px 'JetBrains Mono',monospace;letter-spacing:.08em;text-transform:uppercase;color:#7094bd}
  ...
  .tso-ht-maxgames{display:flex;gap:6px}.tso-ht-maxgames button{width:48px}
  .tso-ht-games{display:flex;flex-direction:column;gap:7px}.tso-ht-game{display:flex;align-items:center;gap:10px;padding:10px 11px;border:1px solid rgba(67,126,196,.25);border-radius:9px;background:#07182f;cursor:pointer}.tso-ht-game input{accent-color:#2d7fff}.tso-ht-game div{flex:1}.tso-ht-game b{display:block;font:800 11px 'Oswald',sans-serif;color:#fff}.tso-ht-game span{display:block;margin-top:2px;font:700 7px 'JetBrains Mono',monospace;color:#7697be}.tso-ht-game em{font:900 7px 'JetBrains Mono',monospace;color:#59e99a;font-style:normal}
  ...
  @media(max-width:680px){
    #nflView .tso-ht-banner{padding:11px;align-items:center}#nflView .tso-ht-bolt{width:34px;height:34px;font-size:18px}#nflView .tso-ht-banner-copy b{font-size:14px}#nflView .tso-ht-banner button{padding:9px 10px;font-size:8px}
    .tso-ht-backdrop{background:rgba(0,5,14,.5)}.tso-ht-drawer{top:auto;bottom:0;left:0;right:0;width:100%;height:min(92dvh,820px);border-left:0;border-top:1px solid rgba(45,127,255,.4);border-radius:18px 18px 0 0}.tso-ht-drawer:before{content:'';position:absolute;top:7px;left:50%;width:42px;height:4px;transform:translateX(-50%);border-radius:99px;background:#385475}.tso-ht-head{padding-top:20px}.tso-ht-scroll{padding-left:15px;padding-right:15px}.tso-ht-summary-grid{grid-template-columns:1fr 1fr}
  }`;
  document.head.appendChild(st);
}

export function halftimeBannerHTML(doc){
  const half=halfBoards(doc),ready=readyBoards(doc);
  ...
  return `<section class="tso-ht-banner pending"><div class="tso-ht-bolt">◐</div><div class="tso-ht-banner-copy"><b>Halftime Model Calculating</b><span>50K simulation / sportsbook candidate board is preparing automatically. No refresh required.</span></div></section>`;
}

export function startHalftimeBoardPolling(onUpdate,{intervalMs=30000}={}){
  if(pollTimer)return;
  const tick=async()=>{
