...
async function swapView(active) {
  ...
  if (active === 'mlb') {
    try {
      const [liveSwitcher,playerParity,playstage,concept,conceptV905,conceptV906,conceptV907,conceptV908,conceptV909,conceptV910,conceptV911,conceptV912] = await Promise.all([
