...
Deno.serve(async (req) => {
  ...
  launch.searchParams.set('return',returnUrl);
  return json({ok:true,requestId,share:{...share,launchUrl:launch.toString()}},201,origin,{'X-ParlayPing-Request-Id':requestId});
});
